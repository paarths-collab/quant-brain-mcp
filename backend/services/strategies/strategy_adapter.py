...
from .reversal_strategy import RSIReversalStrategy
from .rsi_momentum import RSIMomentumStrategy
from .momentum import MomentumStrategy
from .mean_inversion import MeanReversionStrategy
from .breakout_strategy import BreakoutStrategy
from .pullback_fibonacci import FibonacciPullbackStrategy
from .pairs_trading import PairsTradingStrategy
from .support_resistance import SupportResistanceStrategy
from .channel_trading import ChannelTradingStrategy
...
STRATEGY_REGISTRY = {
    ...
    "channel_trading": ChannelTradingStrategy,
}


def get_strategy(strategy_name: str, **params):
