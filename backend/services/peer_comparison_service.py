...
Uses Finnhub for peer list + company names, Yahoo Finance for metrics.
Falls back to FMP screener when Finnhub peers are unavailable.
"""
...
from backend.core.config import FMP_API_KEY, FMP_BASE_URL, FINNHUB_API_KEY, PEERS_PREMIUM
