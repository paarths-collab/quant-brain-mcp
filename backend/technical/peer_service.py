...
PEERS_PREMIUM = os.getenv("PEERS_PREMIUM", "false").lower() == "true"
...
INDIA_PEER_OVERRIDES: Dict[str, List[str]] = {
    "RELIANCE.NS": [
        "ONGC.NS", "IOC.NS", "BPCL.NS", "HINDPETRO.NS",
...
INDIA_FALLBACK_UNIVERSE: List[str] = [
    ...
    "APOLLOHOSP.NS", "TRENT.NS", "LTIM.NS",
]
...
def _fmp_screener_peers(symbol: str, limit: int = 8) -> List[str]:
    """[DELEGATED] Fetches screener peers using unified MarketDataService for metadata."""
