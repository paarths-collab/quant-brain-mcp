...
# from .config import get_market_config # stubbed config
...
# yfinance currently emits a pandas deprecation warning for Timestamp.utcnow.
# This does not affect behavior and can flood logs under repeated history calls.
